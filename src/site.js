...
const login = () => {
    window.location.href =
        `https://rbarchtenant.b2clogin.com/${tenantId}/oauth2/v2.0/authorize?p=B2C_1A_LOSIGNIN&response_type=code&nonce=defaultNonc&prompt=login&redirect_uri=${baseUri}/auth/callback&client_id=${clientId}&scope=${scope}`
